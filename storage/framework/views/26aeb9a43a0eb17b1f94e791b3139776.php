        ...
        <div class="main-content">
            ...
            <div class="filter-container">
                <form method="GET" action="<?php echo e(route('demandes.list')); ?>" class="flex flex-wrap gap-4 mb-4">
                    ...
                    <a href="<?php echo e(route('demandes.list')); ?>" class="btn-view px-4 py-2 rounded-lg bg-gray-300 hover:bg-gray-400">Actualiser</a>
                </form>
            </div> 
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $demandes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $demande): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($demande->document->directeur ?? 'Non défini'); ?></td>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('document', $demande->document_id)); ?>" class="see text-blue-500 hover:text-blue-700">
                                            <i class="fas fa-times mr-2"></i>Voir le document
                                        </a>
                                     
                                        <?php if($demande->documents->estApprouvePourUtilisateur(auth()->id())): ?>
                                        <a href="<?php echo e(route('documents.lecture', $demande->document_id)); ?>" 
...
<?php /**PATH C:\Users\carlo\Desktop\ETUDE ET CONCEOTION D'UN LOGICIEL DE GESTION DE LA BIBLIOTHEQUE DE L'IFTS\CONSPTION\bibliotogo\resources\views/demandes/etudiants/demandeliste.blade.php ENDPATH**/ ?>
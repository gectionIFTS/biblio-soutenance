...
<?php endif; ?>
            ...
            <div class="hidden sm:flex space-x-6">
                <a href="<?php echo e(route('dashboard')); ?>" class="hover:text-gray-200 transition duration-300 mr-3">IFTS</a>
                <a href="#" class="hover:text-gray-200 transition duration-300 mx-6">Cours</a>
...
</nav><?php /**PATH C:\Users\carlo\Desktop\ETUDE ET CONCEOTION D'UN LOGICIEL DE GESTION DE LA BIBLIOTHEQUE DE L'IFTS\CONSPTION\gestiondoc5\gestiondoc5\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>
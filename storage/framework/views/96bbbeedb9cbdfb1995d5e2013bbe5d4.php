    ...
    <div class="container">
        ...
        <div class="main-content">
            ...
            <div class="filter-container">
                <form method="GET" action="<?php echo e(route('demandes.list')); ?>" class="flex flex-wrap gap-4 mb-4">
                    ...
                    <input type="text" name="document" placeholder="Rechercher un document..." class="border p-2 rounded w-full md:w-1/3" value="<?php echo e(request('document')); ?>">
                    <button type="submit" class="btn-view">Rechercher</button>
                    <a href="<?php echo e(route('demandes.list')); ?>" class="btn-view bg-gray-300 hover:bg-gray-400">Actualiser</a>
                </form>
            </div>
            ...
            <div class="overflow-x-auto">
                <table class="table-auto w-full">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo e($demande->documents->titre ?? 'Document inconnu'); ?></td>
                            <td>
                                <?php if($demande->statut ==='approuvee'): ?>
                                    <span class="status btn-accept"><?php echo e(ucfirst($demande->statut)); ?></span>
                                <?php elseif($demande->statut ==="refusee"): ?>
                                    <span class="status btn-reject"><?php echo e(ucfirst($demande->statut)); ?></span>
                                <?php elseif($demande->statut ==="attente"): ?>
                                    <span class="status btn-att"><?php echo e(ucfirst($demande->statut)); ?></span>
                                <?php endif; ?>
                            </td>
                            <td style="display: flex; flex-direction: column; align-items: center; gap: 10px;">
                                <a href="<?php echo e(route('document', $demande->document_id)); ?>" class="see" style="width: max-content;">
                                    <i class="fas fa-eye"></i> Voir le document
                                </a>

                                <?php if($demande->documents->estApprouvePourUtilisateur(auth()->id())): ?>
                                <a href="<?php echo e(route('documents.lecture', $demande->document_id)); ?>" class="read" style="width: max-content;">
...
<?php /**PATH C:\Users\carlo\Desktop\IFTS PROJET DE FIN D'ETUDE\bibliotogo\resources\views/demandes/etudiants/demandeliste.blade.php ENDPATH**/ ?>
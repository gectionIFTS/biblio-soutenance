...
<body>
    ...
    <div class="content-container">
        ...
        <div class="document-details">
            ...
            <p class="bloc"><strong>Description :</strong> <?php echo e($document->description); ?></p>
        ...
        <div class="mt-4">
            <form action="<?php echo e(route('demandes.store')); ?>" method="POST">
                ...
                <?php if($document->estApprouvePourUtilisateur(auth()->id()) || (auth()->check() && auth()->user()->matricule)): ?>
    ...
    <script>
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            <?php if(session('success')): ?>
                ...
                successDiv.textContent = "<?php echo e(session('success')); ?>";
            ...
            <?php if(session('error')): ?>
                ...
                errorDiv.textContent = "<?php echo e(session('error')); ?>";
...
<?php /**PATH C:\Users\carlo\Desktop\IFTS PROJET DE FIN D'ETUDE\bibliotogo\resources\views/layouts/documents/show.blade.php ENDPATH**/ ?>
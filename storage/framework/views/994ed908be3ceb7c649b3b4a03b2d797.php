    ...
    <div class="container ">
        ...
        <div class="main-content">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo e(route('documents.edit', $document->id)); ?>" class="see">
                                        <i class="fas fa-edit"></i>Modifier 
                                    </a>
                                </td>
                                <td>
                                    <a href="<?php echo e(Storage::url($document->chemin_fichier)); ?>" class="see" download>
            ...
            <div class="flex justify-end">
                <a href="<?php echo e(route('adminDashboard')); ?>" class="btn-view">
                    Retour
                </a>
            </div>
        </div>
...
<?php /**PATH C:\Users\carlo\Desktop\IFTS PROJET DE FIN D'ETUDE\bibliotogo\resources\views/layouts/documents/index.blade.php ENDPATH**/ ?>